# BRobotAssistantU3d Project Documentation

## Project Overview
`BRobotAssistantU3d` is a Unity-based software developed for PICO devices to facilitate robot training and remote control. It works in conjunction with PC-side software to achieve robot training and control functionalities.
